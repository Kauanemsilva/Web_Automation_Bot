# config.py - Configurações da Automação MusicDelivery

# ========== CONFIGURAÇÕES DE LOGIN ==========
LOGIN_URL = "http://sistema.musicdelivery.com.br/login?login_error"
EMAIL = "suporte@musicdelivery.com.br"
PASSWORD = "Azul7979@"
...
TIMEOUTS = {
    ...
    "popup_wait": 5000         # Timeout para aguardar popup
}
